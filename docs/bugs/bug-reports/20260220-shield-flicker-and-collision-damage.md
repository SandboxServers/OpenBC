...
1. **Parse the CollisionEffect message** per the wire format in [collision-effect-wire-format.md](../../wire-formats/collision-effect-wire-format.md)
...
This is documented in [fragmented-reliable-ack-bug.md](../fragmented-reliable-ack-bug.md) — the ACK flag byte must indicate fragmented=1 and carry the correct fragment index for the client to clear its retransmit queue.
...
- [combat-system.md](../../game-systems/combat-system.md) — Full damage pipeline
