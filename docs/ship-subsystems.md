...
The Sovereign class (multiplayer ship "Multi1") has 33 subsystems plus a hull reference:

| Subsystem | Count | Max HP (condition) |
|-----------|-------|--------------------|
| Reactor (Primary) | 1 | 12,011 |
| Repair System | 1 | 10,000 |
| Cloaking Device | 1 | 32,000 |
| Powered Systems | 1 | 7,000 |
| Life Support | 1 | 3,000 |
| Shield Generator | 1 | 6,000 |
| Torpedo Tubes | 6 | 550 each |
| Phaser Emitters | 8 | 1,000 each |
| Impulse Engines | 4 | 10,000 each |
| Warp Drive | 1 | 32,000 |
| Phaser Controller | 1 | 32,000 |
| Pulse Weapon | 1 | 6,000 |
| Sensor Array | 1 | 1,000 |
| Reactor (Secondary) | 1 | 12,011 |
| Tractor Beams | 4 | 1,500 each |
| **Total** | **33** | |

### Shield HP (per facing)

| Facing | Max HP | Recharge Rate |
|--------|--------|---------------|
| Front | 6,000 | (per ship class data) |
| Rear | 6,000 | |
| Top | 6,000 | |
| Bottom | 6,000 | |
| Left | 6,000 | |
...
- **Sovereign**: 12,011 total hull HP
...
| radius | f32 | Damage hit radius (used for nearest-subsystem lookup) |
