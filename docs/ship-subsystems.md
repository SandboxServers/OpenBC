...
- Tick 4 (index 6): Repair(3) + Phasers starts (11 bytes would exceed)
- Tick 5 (index 7): Phasers(11) — over budget but completes since it started within budget
- Tick 6 (index 8): Tractors(7) + Warp Engines starts (5 bytes would exceed)
- Tick 7 (index 9): Warp Engines(5) + Bridge(1) = full cycle complete
