...
See [gamemode-system.md](gamemode-system.md) for full scoring specification.
...
- **[pythonevent-wire-format.md](pythonevent-wire-format.md)** — ObjectExplodingEvent (factory 0x8129)
- **[objcreate-wire-format.md](objcreate-wire-format.md)** — ObjCreateTeam (opcode 0x03) for respawn
- **[gamemode-system.md](gamemode-system.md)** — Scoring, frag limits, end game conditions
- **[collision-damage-event-chain.md](collision-damage-event-chain.md)** — Collision → PythonEvent chain
- **[disconnect-flow.md](disconnect-flow.md)** — Player disconnect (separate from ship death)
