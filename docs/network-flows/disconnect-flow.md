...
- **Anti-cheat**: Subsystem hash mismatch (the hash field in StateUpdate position data, see [protocol-reference.md Section 8](../protocol/protocol-reference.md#8-stateupdate-deep-dive-opcode-0x1c))
