...
- **[combat-system.md](combat-system.md)** -- Damage pipeline, shields, weapons, cloaking, tractor, repair
- **[ship-subsystems.md](ship-subsystems.md)** -- Subsystem types and configurations per ship
- **[objcreate-wire-format.md](objcreate-wire-format.md)** -- Species tables (includes BORGCUBE, ENTERPRISE, ESCAPEPOD)
- **[collision-detection-system.md](collision-detection-system.md)** -- Collision detection pipeline
