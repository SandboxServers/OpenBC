...
- **[phase1-engine-architecture.md](phase1-engine-architecture.md)** — Engine class hierarchy and application lifecycle
- **[transport-layer.md](transport-layer.md)** — Network update scheduling and packet processing
- **[power-system.md](power-system.md)** — Power system 1-second timer (game-time domain)
- **[combat-system.md](combat-system.md)** — All combat rate constants that depend on deltaTime
