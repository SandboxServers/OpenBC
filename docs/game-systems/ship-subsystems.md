...
- **[stateupdate-wire-format.md](../wire-formats/stateupdate-wire-format.md)** -- StateUpdate message format, dirty flags, compressed types
- **[combat-system.md](combat-system.md)** -- How damage interacts with subsystems
- **[objcreate-wire-format.md](../wire-formats/objcreate-wire-format.md)** -- Ship creation message
