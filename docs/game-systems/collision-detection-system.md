...
- **[collision-effect-wire-format.md](../wire-formats/collision-effect-wire-format.md)** -- Opcode 0x15 wire format and host validation
- **[collision-damage-event-chain.md](../bugs/collision-damage-event-chain.md)** -- How collision damage generates PythonEvent (0x06) messages
- **[combat-system.md](combat-system.md)** -- Full damage pipeline (collision -> hull/subsystem damage)
- **[server-authority.md](../architecture/server-authority.md)** -- Authority model (collision is client-detected, host-validated)
